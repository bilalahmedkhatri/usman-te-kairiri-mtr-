    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-4">
      ...
      >
        <div className="w-20 h-20 bg-yellow-100 dark:bg-yellow-900/20 rounded-full flex items-center justify-center mx-auto mb-6">
          <Car className="w-10 h-10 text-yellow-600 dark:text-yellow-400" />
        </div>

        <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-2">404</h1>
        <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4">Vehicle Page Not Found</h2>

        <p className="text-gray-600 dark:text-gray-400 mb-8">
          The vehicle inventory page you&apos;re looking for doesn&apos;t exist or has been moved.
        </p>
